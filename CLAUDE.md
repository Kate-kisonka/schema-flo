...
- AI-функциональность заморожена: `application/frontend/hooks/useAI.js`, `application/frontend/services/ai.js` и связанные серверные части не изменяются, не рефакторятся и не аудируются без явного запроса владелицы. Бесплатные модели можно только исследовать и предлагать отдельным решением, не подключать самовольно.
