...
Рабочий AI-контур фронтенда — `CompanionChat`, `useCompanionChat` и `dbCompanionChat`. При его изменении сохрани контракт `/api/companion/*`, прогони frontend-тесты и передай изменения на security review.
